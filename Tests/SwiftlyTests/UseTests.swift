...
@Suite struct UseTests {
    ...
    @Test func useStable() async throws {
    ...
    @Test func useLatestStable() async throws {
        try await SwiftlyTests.withMockedHome(homeName: Self.homeName, toolchains: SwiftlyTests.allToolchains) {
    ...
    @Test func useLatestStablePatch() async throws {
        try await SwiftlyTests.withMockedHome(homeName: Self.homeName, toolchains: SwiftlyTests.allToolchains) {
            try await self.useAndValidate(argument: SwiftlyTests.oldStable.name, expectedVersion: SwiftlyTests.oldStable)
    ...
    @Test func useMainSnapshot() async throws {
        try await SwiftlyTests.withMockedHome(homeName: Self.homeName, toolchains: SwiftlyTests.allToolchains) {
    ...
    @Test func useLatestMainSnapshot() async throws {
        try await SwiftlyTests.withMockedHome(homeName: Self.homeName, toolchains: SwiftlyTests.allToolchains) {
            // Switch to a non-snapshot.
            try await self.useAndValidate(argument: SwiftlyTests.newStable.name, expectedVersion: SwiftlyTests.newStable)
    ...
    @Test func useReleaseSnapshot() async throws {
        try await SwiftlyTests.withMockedHome(homeName: Self.homeName, toolchains: SwiftlyTests.allToolchains) {
            // Switch to a non-snapshot.
            try await self.useAndValidate(argument: SwiftlyTests.newStable.name, expectedVersion: SwiftlyTests.newStable)
            try await self.useAndValidate(
    ...
    @Test func useLatestReleaseSnapshot() async throws {
        try await SwiftlyTests.withMockedHome(homeName: Self.homeName, toolchains: SwiftlyTests.allToolchains) {
            // Switch to a non-snapshot.
            try await self.useAndValidate(argument: SwiftlyTests.newStable.name, expectedVersion: SwiftlyTests.newStable)
    ...
    @Test func useNoInstalledToolchains() async throws {
    ...
    @Test func useNonExistent() async throws {
        try await SwiftlyTests.withMockedHome(homeName: Self.homeName, toolchains: SwiftlyTests.allToolchains) {
